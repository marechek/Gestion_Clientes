...
from src.validators.customer_validators import (
    validate_email, validate_phone, validate_address, validate_customer_id
)

def test_validar_email_ok():
    assert validate_email("Juan.Test+1@Mail.com") == "juan.test+1@mail.com"
...
def test_validar_telefono_ok():
    assert validate_phone("12 345-678") == "12345678"
    assert validate_phone("+56 9 1234-5678").startswith("+")
